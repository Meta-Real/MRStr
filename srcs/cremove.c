 ...
 *
 * void mrstr_cremove(mrstr_p, mrstr_pc, mrstr_chr)
...
void mrstr_cremove(mrstr_p res, mrstr_pc str, mrstr_chr chr)
{
    ...
    if (!MRSTR_DATA(res))
        mrstr_dbg_aloc_err("mrstr_cremove", MRSTR_LEN(str) + 1, );
    ...
    if (!tdata)
        mrstr_dbg_aloc_err("mrstr_cremove", j + 1, );
