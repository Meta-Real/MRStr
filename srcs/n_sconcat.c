 ...
 *
 * void mrstr_n_sconcat(mrstr_p, mrstr_pc, mrstr_size, mrstr_cstr)
...
void mrstr_n_sconcat(mrstr_p res, mrstr_pc str1, mrstr_size len, mrstr_cstr str2)
{
    ...
    if (res == str1)
    {
        ...
        if (!(str2 && (slen = strlen(str2))))
        {
            ...
            if (!tdata)
                mrstr_dbg_aloc_err("mrstr_n_sconcat", len + MRSTR_OFFSET(res) + 1, );
        ...
        if (!tdata)
            mrstr_dbg_aloc_err("mrstr_n_sconcat", MRSTR_LEN(res) + MRSTR_OFFSET(res) + 1, );
    ...
    if (!len)
    {
        ...
        if (!MRSTR_DATA(res))
            mrstr_dbg_aloc_err("mrstr_n_sconcat", slen + 1, );
    ...
    if (!(str2 && (slen = strlen(str2))))
    {
        ...
        if (!MRSTR_DATA(res))
            mrstr_dbg_aloc_err("mrstr_n_sconcat", len + 1, );
    ...
    if (!MRSTR_DATA(res))
        mrstr_dbg_aloc_err("mrstr_n_sconcat", MRSTR_LEN(res) + 1, );
